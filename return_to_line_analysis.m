fprintf("Graficacion y estadisticas de los 8 experimentos en returnLine recta \n\n")
% Set the Carmaker path
cmenv; fprintf('\n')
% we declare the path for the signals resulting from our tests
vL0 = ([pwd,'\','returnLine\','Variation 0','.erg']);
vL1 = ([pwd,'\','returnLine\','Variation 1','.erg']);
vL2 = ([pwd,'\','returnLine\','Variation 2','.erg']);
vL3 = ([pwd,'\','returnLine\','Variation 3','.erg']);
vL4 = ([pwd,'\','returnLine\','Variation 4','.erg']);
vL5 = ([pwd,'\','returnLine\','Variation 5','.erg']);
vL6 = ([pwd,'\','returnLine\','Variation 6','.erg']);
vL7 = ([pwd,'\','returnLine\','Variation 7','.erg']);
...
% %% Graphs
subplot(3,3,1); hold on; plot(Time_s0,TrailerAngle_deg0); plot(Time_s0,DesiredAngle_deg0); hold off; legend("ReturnToLine 0");
subplot(3,3,2); hold on; plot(Time_s1,TrailerAngle_deg1); plot(Time_s1,DesiredAngle_deg1); hold off; legend("ReturnToLine 1");
subplot(3,3,3); hold on; plot(Time_s2,TrailerAngle_deg2); plot(Time_s2,DesiredAngle_deg2); hold off; legend("ReturnToLine 2");
subplot(3,3,4); hold on; plot(Time_s3,TrailerAngle_deg3); plot(Time_s3,DesiredAngle_deg3); hold off; legend("ReturnToLine 3");
subplot(3,3,5); hold on; plot(Time_s4,TrailerAngle_deg4); plot(Time_s4,DesiredAngle_deg4); hold off; legend("ReturnToLine 4");
subplot(3,3,6); hold on; plot(Time_s5,TrailerAngle_deg5); plot(Time_s5,DesiredAngle_deg5); hold off; legend("ReturnToLine 5");
subplot(3,3,7); hold on; plot(Time_s6,TrailerAngle_deg6); plot(Time_s6,DesiredAngle_deg6); hold off; legend("ReturnToLine 6");
subplot(3,3,8); hold on; plot(Time_s7,TrailerAngle_deg7); plot(Time_s7,DesiredAngle_deg7); hold off; legend("ReturnToLine 7");
grid on
...
%% Calculando valores estadisticos generales del las pruebas en returnLine 
